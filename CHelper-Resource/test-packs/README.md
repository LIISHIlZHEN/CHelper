...
- `pack-a.chepack` —— 测试资源包 A（v0.5.0）：自定义命令（/welcome 与别名 /hi、/grant、/execute myaction）、内置表引用（/pentity、/pitem、/pblock、/pgamemode）、自定义方块 demo:demo_machine 与自定义物品、选择器自定义变量 @x + 布尔参数 myflag、JSON 结构参数 /pjson；全部 JSON 带 `//` 注释；
